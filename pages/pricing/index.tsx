        ...
        <div className="flex gap-12 flex-col md:flex-row justify-between md:flex-wrap">
          <div className="flex flex-col items-center basis-[30%] p-16 bg-base rounded-2xl gap-8 drop-shadow-md">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-2xl text-white opacity-70">50 минути</span>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-2xl text-white opacity-70">25 минути</span>
              <h3 className="text-2xl text-white font-bold text-center">
                30 лв.
              </h3>
            </div>
          ...
          <div className="flex flex-col items-center basis-[30%] p-16 bg-base rounded-2xl gap-8 drop-shadow-md">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-2xl text-white opacity-70">9,00 лв.</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <h2 className="text-3xl text-white font-bold text-center">
                Месечна карта
              </h2>
              <span className="text-2xl text-white opacity-70">79,00 лв.</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <h2 className="text-3xl text-white font-bold text-center">
                8 посещения <div className="text-primary inline-block">*</div>
              </h2>
              <span className="text-2xl text-white opacity-70">59,00 лв.</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <h2 className="text-3xl text-white font-bold text-center">
          ...
          <div className="flex flex-col items-center basis-[30%] p-16 bg-base rounded-2xl gap-8 drop-shadow-md">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-2xl text-white opacity-70">60 минути</span>
              <h3 className="text-2xl text-white font-bold text-center">
                50 лв.
              </h3>
            </div>
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-2xl text-white opacity-70">90 минути</span>
              <h3 className="text-2xl text-white font-bold text-center">
                30 лв.
              </h3>
            </div>
